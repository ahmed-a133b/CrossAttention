...
class ColabDatasetManager:
    ...
    def __init__(self, base_path: str = "/content/plant_disease_data"):
        ...
        self.dataset_path = os.path.join(base_path, "plantwild")
    ...
    def verify_dataset(self) -> Tuple[bool, dict]:
        ...
        prompts_file = os.path.join(self.base_path, "plantwild_prompts.json")
        info['prompts_file_exists'] = os.path.exists(prompts_file)
        ...
        # Check images
        if info['images_path_exists']:
            class_dirs = [d for d in os.listdir(self.images_path) 
